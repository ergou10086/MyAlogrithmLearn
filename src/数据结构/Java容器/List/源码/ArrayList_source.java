package 数据结构.Java容器.List.源码;

import java.util.*;

// ArrayList的源码
public class ArrayList_source<E> extends AbstractList<E>
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    // 带初始容量参数的构造函数
    public ArrayList_source(int initialCapacity) {
        super();
    ...
    // 默认构造函数，其默认初始容量为10
    public ArrayList_source() {
        super();
        this.elementData = EMPTY_ELEMENTDATA;
    }

    // 带Collection参数的构造函数
    public ArrayList_source(Collection<? extends E> c) {
    ...
    public Object clone() {
        try {
            ...
            ArrayList_source<E> v = (ArrayList_source<E>) super.clone();
